      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 15, color: "#94A3B8", lineHeight: 1.6 }}>
            Akses penuh fitur Aexon untuk mendukung praktik Anda
          </p>
        </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ marginBottom: 16 }}>
                      ...
                      {isAnnual && monthlySavings > 0 && (
                        ...
                        >
                          ...
                          Ditagih {formatRupiah(annualTotal)}/tahun · Hemat{" "}
                    ...
                    {Array.isArray(planItem.features) &&
                      ...
                      (() => {
                        const filteredFeatures = planItem.features.filter(
