      ...
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Monitor status paket, penggunaan seat, dan informasi penagihan
            institusi.
          </p>
        </div>
      </div>
              ...
              <div className="p-6 bg-white/10 rounded-3xl border border-white/10 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-bold">
                      Penggunaan Seat Dokter
                    </span>
                  </div>
                  <span className="text-sm font-black">
                    {subscriptionInfo.usedSeats} / {subscriptionInfo.totalSeats}{" "}
                    Akun
                  </span>
                </div>
                <div className="w-full h-3 bg-white/10 rounded-full overflow-hidden p-0.5">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{
                      width: `${(subscriptionInfo.usedSeats / subscriptionInfo.totalSeats) * 100}%`,
                    }}
                ...
                <p className="text-[10px] text-indigo-200 mt-4 font-medium italic">
                  * Anda masih memiliki{" "}
                  {subscriptionInfo.totalSeats - subscriptionInfo.usedSeats}{" "}
                  slot dokter yang tersedia untuk didaftarkan.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 text-sm mb-8 leading-relaxed">
                Manajer akun Enterprise Anda siap membantu konfigurasi sistem
                atau penambahan fitur khusus.
              </p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs font-medium">
                      {activeModal === "seats" &&
                        "Perluas akses untuk lebih banyak dokter di institusi Anda."}
                      {activeModal === "payment" &&
                        "Kelola kartu kredit atau metode pembayaran otomatis lainnya."}
                      {activeModal === "billing" &&
                        "Daftar invoice dan status pembayaran langganan Anda."}
                    </p>
                  </div>
                </div>
                <button
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-3xl p-6 flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-sm font-bold text-blue-900 mb-1">
                          Informasi Penambahan Seat
                        </h4>
                        <p className="text-xs text-blue-700 leading-relaxed">
                          Penambahan seat akan dikenakan biaya prorata hingga
                          akhir periode langganan saat ini. Biaya per seat
                          tambahan adalah Rp 450.000 / bulan.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between text-base">
                          ...
                          <span className="font-black text-blue-600 underline underline-offset-4">
                            55 Seat
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl text-white relative overflow-hidden shadow-xl">
                        ...
                        <div className="relative z-10">
                          ...
                          <p className="text-xl font-black tracking-[0.2em] mb-6">
                            •••• •••• •••• 4242
                          </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 text-center">
                      <p className="text-xs text-slate-500 font-medium">
                        Menampilkan 3 riwayat penagihan terakhir. Untuk riwayat
                        lengkap, silakan hubungi tim finansial Aexon.
                      </p>
                    </div>
                  </div>
                )}
