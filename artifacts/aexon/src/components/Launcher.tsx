...
export default function Launcher({ onLogin }: LauncherProps) {
  ...
  const cardStyle: React.CSSProperties = {
    ...
    padding: 44,
    boxShadow:
      "0 20px 60px rgba(12,30,53,0.12), 0 8px 24px rgba(12,30,53,0.08)",
    position: "relative",
    zIndex: 1,
  };
  ...
  const loginTypeCard = (
    ...
    return (
      ...
      >
        ...
        <span
          style={{ fontSize: 11, lineHeight: 1.3, opacity: selected ? 0.8 : 1 }}
        >
          {subtitle}
        </span>
      </button>
          ...
          <div style={cardStyle}>
            ...
            {resetSent ? (
              <div style={{ textAlign: "center", padding: "32px 0" }}>
                ...
                >
                  <CheckCircle2
                    style={{ width: 32, height: 32, color: "#0C1E35" }}
                  />
                </div>
                <h2
                  className="font-aexon"
                  style={{ fontSize: 24, color: "#0C1E35", marginBottom: 8 }}
                >
          ...
          >
            <div style={cardStyle}>
              ...
              <div style={{ textAlign: "center", padding: "16px 0" }}>
                ...
                <h2
                  className="font-aexon"
                  style={{ fontSize: 24, color: "#0C1E35", marginBottom: 12 }}
                >
          ...
          <div style={cardStyle}>
            ...
            {regSuccess ? (
              ...
              <>
                <h2
                  className="font-aexon"
                  style={{ fontSize: 24, color: "#0C1E35", marginBottom: 4 }}
                >
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      background:
                        institusiRole === "doctor" ? "white" : "transparent",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      background:
                        institusiRole === "admin" ? "white" : "transparent",
